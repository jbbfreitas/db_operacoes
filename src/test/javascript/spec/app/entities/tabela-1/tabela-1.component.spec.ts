...
import { Tabela1Component } from 'app/entities/tabela-1/tabela-1.component';
import { Tabela1Service } from 'app/entities/tabela-1/tabela-1.service';
import { Tabela1 } from 'app/shared/model/tabela-1.model';

describe('Component Tests', () => {
  describe('Tabela1 Management Component', () => {
    let comp: Tabela1Component;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(Tabela1Component, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tabela1S[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
